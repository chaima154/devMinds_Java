...
import tn.devMinds.iservices.TrancheCrud;
...
public class tranchesPdf {
    public static void makeTranchesPdf(Credit credit) throws IOException {
        ...
        String path = "C:/Users/chaima/Downloads/Credit.pdf";
        ...
        table.addCell(new Cell().add(new Paragraph("£FRANK")).setFontSize(20f).setBorder(Border.NO_BORDER).setBold());
        ...
        Border dgb = new DashedBorder(new DeviceRgb(0x80, 0x80, 0x80), 0.5f);
        ...
        threeColTable1.addCell(new Cell().add(new Paragraph("Montant à Payer")).setBold().setFontColor(new DeviceRgb(255, 255, 255)).setBorder(Border.NO_BORDER).setTextAlignment(TextAlignment.LEFT).setMarginLeft(10f));
        threeColTable1.addCell(new Cell().add(new Paragraph("Date Echeance")).setBold().setFontColor(new DeviceRgb(255, 255, 255)).setTextAlignment(TextAlignment.CENTER).setBorder(Border.NO_BORDER));
        threeColTable1.addCell(new Cell().add(new Paragraph("Date Echeance")).setBold().setFontColor(new DeviceRgb(255, 255, 255)).setTextAlignment(TextAlignment.RIGHT).setBorder(Border.NO_BORDER).setMarginRight(15f));
        ...
        for(Tranche tranche: tranches){
            threeColTable2.addCell(new Cell().add(new Paragraph(String.valueOf(tranche.getMontantPaiement()))).setBorder(Border.NO_BORDER)).setTextAlignment(TextAlignment.LEFT).setMarginLeft(10f);
            threeColTable2.addCell(new Cell().add(new Paragraph(String.valueOf(tranche.getDateEcheance()))).setTextAlignment(TextAlignment.CENTER).setBorder(Border.NO_BORDER));
            threeColTable2.addCell(new Cell().add(new Paragraph(tranche.getStatutPaiement())).setTextAlignment(TextAlignment.RIGHT).setBorder(Border.NO_BORDER)).setMarginRight(10f);
        }

        document.add(threeColTable2);
        document.add(tableDevider2);
        document.add(new Paragraph("\n"));
        document.add(divider.setBorder(new SolidBorder(new DeviceRgb(0x80, 0x80, 0x80), 1)).setMarginBottom(15f));
